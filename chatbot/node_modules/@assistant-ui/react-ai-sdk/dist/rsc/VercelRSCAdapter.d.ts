...
export type VercelRSCAdapter<T = VercelRSCMessage> = VercelRSCAdapterBase<T> & (T extends VercelRSCMessage ? object : RSCMessageConverter<T>);
export {};
//# sourceMappingURL=VercelRSCAdapter.d.ts.map